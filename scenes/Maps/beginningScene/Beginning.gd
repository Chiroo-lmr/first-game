...
func _ready():
	...
	if Global.cameraPosition == Vector2(10, 15): $WorldCamera.position = Global.cameraPosition
	if Global.cameraPosition == Vector2(471, 180): $WorldCamera.position = Global.cameraPosition
...
func _on_cliff_side_transition_point_body_entered(body):
	if body.has_method("player"):
		...
		Global.cameraPosition = Vector2(10, 15)
...
func _on_cliff_side_2_transition_point_body_entered(body):
	if body.has_method("player"):
		...
		Global.cameraPosition = Vector2(471, 180)
